...
function postPage(id) {
    ...
    fetch(`https://gorest.co.in/public/v2/posts/${id}`).then(async (res)=>{
        ...
        (0, _redom.setChildren)(body, (0, _redom.el)("div", {
            className: "card-body"
        }, [
...
function postListPage() {
    const list = (0, _redom.el)("ul", {
        className: "list-group list-group-flush"
    }, (0, _redom.el)("li", "Loading..."));
    fetch("https://gorest.co.in/public/v2/posts").then(async (res)=>{
        const data = await res.json();
        (0, _redom.setChildren)(list, data.map((post)=>(0, _redom.el)("li", {
...
router.on("/", ()=>{
    (0, _redom.setChildren)(window.document.body, postListPage());
});
router.on("/posts/:id", ({ data: { id } })=>{
    (0, _redom.setChildren)(window.document.body, postPage(id));
});
router.resolve();

},{"redom":"cWIuY","navigo":"fuSlc","bootstrap":"h36JB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cWIuY":[function(require,module,exports) {
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DoTH","adjPd"], "adjPd", "parcelRequirefc40")
